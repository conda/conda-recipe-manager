...
class CbcParser(RecipeReader):
    ...
    @staticmethod
    def generate_variants(final_cbc: CbcOutputType) -> tuple[dict[str, Primitives]]:
        """
        Generates a list of variants from a final CBC output.
        The variants are generated by combining the values of the CBC variables.

        :param final_cbc: Final CBC output to generate the variants from.
        :returns: List of variants.
        """
        cbc_values, zip_keys = final_cbc
        ...
        all_keys: list[str] = unzipped_keys + zip_keys_tuples
