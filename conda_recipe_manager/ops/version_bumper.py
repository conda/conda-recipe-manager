...
class VersionBumper:
    ...
    def _is_valid_futures_tbl(fetcher_tbl: FetcherFuturesTable) -> bool:
        """
        Helper function that attempts to partially validate the provided fetchers future table to allow for a quick
        bail-out point.
    ...
    def update_http_urls(self, fetcher_tbl: FetcherFuturesTable) -> None:
        ...
        :param fetcher_tbl: Table of future fetchers, generated by one of the factory functions found in the
