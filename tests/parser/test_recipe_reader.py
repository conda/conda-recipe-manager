...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("sub_vars.yaml", "/requirements/fake_run_constrained/2", True, '{{ number + "1" }}'),
        ("sub_vars.yaml", "/requirements/fake_run_constrained/3", True, "{{ number + '1.3' }}"),
        ("sub_vars.yaml", "/requirements/fake_run_constrained/4", True, 43),
        ("sub_vars.yaml", "/requirements/fake_run_constrained/5", True, 43.3),
        ("sub_vars.yaml", "/requirements/fake_run_constrained/6", True, '{{ "1" + number }}'),
        ("sub_vars.yaml", "/requirements/fake_run_constrained/7", True, "{{ '1.3' + number }}"),
        ("sub_vars.yaml", "/requirements/fake_run_constrained/8", True, "{{ version + 1.3 }}"),
        ("sub_vars.yaml", "/requirements/fake_run_constrained/9", True, "0.10.8.61.3"),
        ("sub_vars.yaml", "/requirements/fake_run_constrained/10", True, "{{ 1.3 + version }}"),
        ...
        ("v1_format/v1_simple-recipe.yaml", "/package/name", False, "${{ name|lower if unix else '' }}"),
        ("v1_format/v1_simple-recipe.yaml", "/package/name", True, "${{ name|lower if unix else '' }}"),
        ...
        ("v1_format/v1_sub_vars.yaml", "/requirements/fake_run_constrained/2", True, '${{ number + "1" }}'),
        ("v1_format/v1_sub_vars.yaml", "/requirements/fake_run_constrained/3", True, "${{ number + '1.3' }}"),
        ...
        ("v1_format/v1_sub_vars.yaml", "/requirements/fake_run_constrained/6", True, '${{ "1" + number }}'),
        ("v1_format/v1_sub_vars.yaml", "/requirements/fake_run_constrained/7", True, "${{ '1.3' + number }}"),
        ("v1_format/v1_sub_vars.yaml", "/requirements/fake_run_constrained/8", True, "${{ version + 1.3 }}"),
        ("v1_format/v1_sub_vars.yaml", "/requirements/fake_run_constrained/9", True, "0.10.8.61.3"),
        ("v1_format/v1_sub_vars.yaml", "/requirements/fake_run_constrained/10", True, "${{ 1.3 + version }}"),
