...
def load_recipe(
    file_name: Path | str, recipe_parser: Type[R], parser_flags: RecipeReaderFlags = RecipeReaderFlags.NONE
) -> R:
    """
    ...
    :param parser_flags: RecipeReaderFlags to be set. Defaults to `RecipeReaderFlags.NONE`.
